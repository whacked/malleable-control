...
out="$("$GT_CLI" "$GT_IMAGE" eval "
  ...
  #( #NatsClientTest #McRelationTest #McCacheTest #McMarkdownTest #McMarkdownSnapshotTest #McMarkdownReconcilerTest #McRichEditPerfTest #McMarkdownLinkTest #McSearchMatcherTest #McSearchSessionTest ) do: [ :each |
